...
def scale_menu(screen_width, screen_height):
    ...
    # audioMenuButtons
    music_button = Button(screen_width / (1280 / 541), screen_height/ (720 / 432), music_img, music_img_highlighted, scale)
    sound_button = Button(screen_width / (1280 / 655), screen_height/ (720 / 432), sound_img, sound_img_highlighted, scale)
